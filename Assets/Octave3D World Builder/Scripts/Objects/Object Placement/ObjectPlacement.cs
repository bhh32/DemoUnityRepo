    ...
    public class ObjectPlacement : ScriptableObject, IMessageListener
    {
        ...
        public void HandleRepaintEvent(Event e)
        {
            ...
            else
            {
                ...
                if (!AllShortcutCombos.Instance.ActivateObjectVertexSnapSession.IsActive()) _objectVertexSnapSession.End();
            }
        }
        ...
        public void HandleMouseButtonDownEvent(Event e)
        {
            ...
            if (AllShortcutCombos.Instance.SnapXZGridToCursorPickPointOnLeftClick.IsActive() && e.InvolvesLeftMouseButton())
            {
        ...
        public void HandleKeyboardButtonDownEvent(Event e)
        {
            ...
            if (AllShortcutCombos.Instance.ActivateObjectVertexSnapSession.IsActive() && CanActivateObjectVertexSnapSession())
            {
                e.DisableInSceneView();
        ...
        {
            if (AllShortcutCombos.Instance.SnapXZGridToCursorPickPointOnLeftClick.IsActive()) return false;
        ...
        {
            if(!_objectVertexSnapSession.IsActive && !AllShortcutCombos.Instance.SnapXZGridToCursorPickPointOnLeftClick.IsActive())
            {
