...
namespace O3DWB
{
    ...
    public class ObjectSelection : ScriptableObject
    {
        ...
        public void HandleMouseButtonDownEvent(Event e)
        {
            ...
            if (_selectionGridSnapSession.IsActive || _selectionGrabSession.IsActive || _object2ObjectSnapSession.IsActive) return;
        ...
        public void HandleKeyboardButtonDownEvent(Event e)
        {
            ...
            if (AllShortcutCombos.Instance.ToggleGizmosOnOff.IsActive())
            {
                ...
                _objectSelectionGizmos.AreGizmosActive = !_objectSelectionGizmos.AreGizmosActive;
